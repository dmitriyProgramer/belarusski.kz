	...
	setTimeout(function(){
		window.delInt5 = setInterval(function(){
			...
			if( $('div').is('.t-store__prod-popup__btn-wrapper') ){
				...
				$('.whatsapp__com').css({"position":"relative", "font-family":"Futura", "color":"#fff", "display":"block", "width":"164px", "text-align":"right", "background":"#3BBF26", "font-size":"19px", "margin":"0 0 7px 0", "padding":"11px 48px 11px 0px"});
